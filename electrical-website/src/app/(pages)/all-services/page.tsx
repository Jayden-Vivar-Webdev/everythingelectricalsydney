            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <header className="text-left mb-12">
                ...
                <p className="mb-6 mt-5 text-lg md:text-xl text-gray-600">
                  Comprehensive electrical services across {locationName} and
                  surrounding areas
                </p>
              </header>
              <MapLocations />
            ...
            <div className="container mx-auto px-4">
              <header className="text-center mb-20">
                ...
                <p className="mb-6 text-lg md:text-xl text-white">
                  Professional electrical services with multiple convenient ways
                  to reach our certified specialists in {locationName}
                </p>
              </header>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                ...
                <div className="group bg-gray-800 p-10 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-700 hover:border-red-500/50 relative overflow-hidden">
                  ...
                  <div className="flex flex-col items-center text-center h-full">
                    <div
                      className="w-20 h-20 bg-gradient-to-br from-red-500 to-red-600 rounded-full flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300 shadow-lg"
                      aria-hidden="true"
                    >
                    ...
                    <p className="text-gray-300 mb-8 leading-relaxed flex-grow">
                      Direct access to our certified electrical specialists for
                      immediate professional consultation and emergency services
                      in {locationName}.
                    </p>
                ...
                <div className="group bg-gray-800 p-10 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-700 hover:border-red-500/50 relative overflow-hidden">
                  ...
                  <div className="flex flex-col items-center text-center h-full">
                    ...
                    <p className="text-gray-300 mb-8 leading-relaxed flex-grow">
                      Professional correspondence for project inquiries,
                      detailed quotes, and comprehensive electrical assessments
                      in {locationName}.
                    </p>
                    <div className="mt-auto">
                      ...
                      <div className="text-gray-400 mb-4 text-lg hover:text-gray-300 transition-colors block break-all">
                ...
                <div className="group bg-gray-800 p-10 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-700 hover:border-red-500/50 relative overflow-hidden">
                  ...
                  <div className="flex flex-col items-center text-center h-full">
                    ...
                    <p className="text-gray-300 mb-8 leading-relaxed flex-grow">
                      Comprehensive electrical services delivered across{" "}
                      {locationName} and Sydney&apos;s metropolitan area with
              ...
              <footer className="mt-16 pt-12 border-t border-gray-700">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                  ...
                  <div className="flex flex-col items-center">
                    <div
                      className="w-12 h-12 bg-blue-500/20 rounded-full flex items-center justify-center mb-3 border border-blue-500
                    transition-all duration-500 hover:scale-110 hover:border-blue-400"
                      aria-hidden="true"
                    >
                  ...
                  <div className="flex flex-col items-center">
                    <div
                      className="w-12 h-12 bg-orange-500/20 rounded-full flex items-center justify-center mb-3 
                    border border-orange-500 transition-all duration-500 hover:scale-110 hover:border-orange-400"
                      aria-hidden="true"
                    >
