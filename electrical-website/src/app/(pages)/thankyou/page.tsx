...
export const metadata = {
  title:
    "Thank You — Everything Electrical Sydney | We’ve Received Your Message",
  description:
            ...
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              <div className="text-center">
                ...
                <p className="mt-8 text-pretty text-lg font-medium text-gray-200 sm:text-xl/8">
                  We will get back to you shortly. If you would like to speak to
                  us immediately please click the &ldquo;Call Now&rdquo; button
                  below.
                </p>
