...
export const metadata = {
    title: 'Areas We Serve — Everything Electrical Sydney | Local Electricians Across Sydney',
    description:
    ...
    openGraph: {
      ...
      title: 'Everything Electrical Sydney — Electrical Services Across Sydney & Surrounds',
      description:
