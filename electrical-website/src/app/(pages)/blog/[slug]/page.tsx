...
export async function generateMetadata({ params }: {params: Params}) {
  ...
  return {
    title: `${post.title} | Nexa Web Blog`,
    description: 'Tips, SEO, and web dev advice from Nexa Web.',
    canonical: `https://nexawebdev.com/blog/${slug}`,
    openGraph: {
      title: `${post.title} | Nexa Web Blog`,
      description: 'Tips, SEO, and web dev advice from Nexa Web.',
      url: `https://nexawebdev.com/blog/${slug}`,
      siteName: 'Nexa Web',
      images: [
        {
          url: imageUrl,
