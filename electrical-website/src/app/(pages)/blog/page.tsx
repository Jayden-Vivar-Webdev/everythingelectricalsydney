...
import { blogPageStructuredData } from "@/app/data/local-business-data";
...
export const metadata = {
  title:
    "Everything Electrical Sydney Blog — Electrical Tips & Industry Insights",
  description:
        ...
        <section className="relative bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 py-20 px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
              Stay ahead with expert electrical advice, safety protocols, and
              industry developments from Sydney&apos;s trusted electrical
              professionals.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                Comprehensive electrical guidance for homeowners, strata
                managers, and businesses across Sydney.
              </p>
            </div>
