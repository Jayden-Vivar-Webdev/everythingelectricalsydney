...
const values = [
  {
    ...
    description:
      "All our electricians are fully licensed and insured for complete peace of mind.",
  ...
  },
  {
    name: "Safety First",
    description:
      "We follow strict safety protocols to protect your home, family, or workplace.",
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-5xl pt-20 pb-16 text-center lg:pt-32 lg:pb-24">
            ...
            <p className="space-y-6 mt-6 text-lg md:text-xl leading-8 text-gray-600 text-slate-600">
              ...
              successful projects behind us from family homes and apartments to
              large commercial and industrial sites our goal has always stayed
              the same: deliver quality work, honest advice, and real peace of
              mind.
            </p>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <div className="space-y-6 mt-6 text-lg md:text-xl leading-8 text-gray-600 text-slate-600">
                <p>
                  With over 5,000 projects completed and more than 1,000
                  satisfied clients, our experience speaks for itself. We know
                  every customer, every home, and every business is different,
                  which is why we take the time to listen, explain, and deliver
                  solutions that work long-term — not quick fixes.
                </p>
              </div>
            </div>
              ...
              <div className="aspect-square rounded-2xl bg-gray-900 p-8 shadow-2xl">
                <div className="grid grid-cols-2 gap-6 h-full">
                  {stats.map((stat, index) => (
                    <div
                      key={index}
                      className="flex flex-col justify-center items-center text-center bg-slate-800/80 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300"
                    >
                      <div className="text-3xl font-bold text-white lg:text-4xl">
                        {stat.value}
                      </div>
                      <div className="text-sm font-medium text-white mt-2 uppercase tracking-wide">
                        {stat.label}
                      </div>
            ...
            <div className="absolute inset-0 flex items-end p-8 lg:p-12">
              <div className="max-w-2xl">
                ...
                <p className="mt-4 text-lg text-slate-200">
                  The best services and methodologies ensuring superior results
                  on every project.
                </p>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white lg:text-5xl">
              Why Sydney Chooses Everything Electrical
            </h2>
            <div className="mt-6 flex justify-center">
              <div className="h-1 w-24 bg-gradient-to-r from-red-600 to-red-700 rounded-full"></div>
            </div>
            <p className="mt-6 text-xl text-slate-300 max-w-3xl mx-auto">
              We understand that inviting an electrician into your home or
              business requires trust. That’s why we keep things simple,
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {values.map((value) => (
              <div
                key={value.name}
                className="relative bg-slate-800/50 rounded-xl p-8 hover:bg-slate-800/70 transition-colors duration-300"
              >
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-6 text-xl text-slate-600 max-w-3xl mx-auto">
              Showcasing our comprehensive electrical expertise across diverse
                  ...
                  <div className="mx-auto grid max-w-full grid-cols-1 items-start gap-x-8 gap-y-12 sm:gap-y-16 lg:mx-0 lg:grid-cols-1">
                    <div className="lg:pl-4">
                      <div className="text-sm sm:text-base leading-7 text-slate-700">
                        {/* Heading */}
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900">
                        ...
                        <div className="mt-6 text-xl leading-8 text-gray-600 text-slate-600">
                          <p className="mb-6 text-lg md:text-xl text-gray-600">
                            We’re proud to say our business is built on repeat
                            customers and referrals. People come back to us
                            because we’re not just here to “fix a job” we’re
                            here to build trust and long-term partnerships.
                          </p>
                          ...
                          <ul className="py-1 text-gray-600 list-disc list-inside space-y-2 mb-6 text-lg md:text-xl">
                            ...
                            <li className="flex items-start gap-2 text-lg md:text-xl mb-5">
                              ...
                              <span>
                                Clear Communication:&nbsp;We explain the work,
                                update you along the way, and keep pricing
                                upfront.
                              </span>
                            </li>
                            ...
                            <li className="flex items-start gap-2 text-lg md:text-xl mb-5">
                              ...
                              <span>
                                Reliability:&nbsp;We turn up on time, prepared,
                            ...
                            <li className="flex items-start gap-2 text-lg md:text-xl mb-5">
                              ...
                              <span>
                                ...
                                energy-efficient upgrades, we keep up with the
                                latest technology.
                              </span>
                            </li>
                            ...
                            <li className="flex items-start gap-2 text-lg md:text-xl mb-5">
                              ...
                              <span>
                                Community Focus:&nbsp;As a local Sydney team,
                                we’re proud to support families, businesses, and
