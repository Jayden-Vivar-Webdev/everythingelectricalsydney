      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            ...
            <span className="block text-red-600 text-3xl md:text-4xl font-bold mb-4">
              Service Areas
            </span>
          </h2>
          <p className="mt-6 text-lg md:text-xl leading-8 text-gray-600 text-slate-600 text-slate-600">
            Providing reliable, professional electrical and air conditioning
            services across Sydney, NSW, Australia.
            <br />
            <br />
            <strong>
              Can’t see your suburb listed? Don’t worry we cover many more
              areas. Get in touch and we’ll confirm if we can service your
              location.
            </strong>
          </p>
          ...
          <Link
            href={"#contact"}
            className="mt-10 group inline-flex items-center gap-2 rounded-lg bg-red-600 px-6 py-3 sm:px-6 sm:py-3 text-md font-semibold text-white shadow-lg transition-all duration-200 hover:bg-red-700 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
          >
