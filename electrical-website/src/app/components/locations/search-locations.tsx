...
const groupedLocations = {
  "Greater Sydney": [
    ...
    "Campbelltown", "Camden", "Oran Park", "Narellan", 
    "Glenmore Park", "St Marys", "Narellan Vale",
    "Eastwood", "Marsfield", "Melrose Park", "Denistone", 
    "Denistone East", "Denistone West", "Liberty Grove", "Meadowbank", "Mays Hill", "Lidcombe",
    "Mount Annan", "Mount Lewis", "Mount Pritchard", "Mount Vernon", "Mulgoa", "Mulgrave",
    "Newington", "Nirimba Fields", "North Parramatta", "North Rocks", "North Ryde", 
    "North St Marys", "Northmead", "Norwest", "Oakhurst", "Oakville", "Oatlands", 
    "Old Guildford", "Old Toongabbie", "Orchard Hills", "Oxley Park", "Parklea", 
    "Pemulwuy", "Pendle Hill", "Pennant Hills", "Plumpton", "Prospect", "Pitt Town", 
    "Ropes Crossing", "Riverstone", "Regentville", 'Glenhaven', 'Glenorie', 'Glenwood', 'Grantham Farm', 'Green Valley',
    'Greenacre', 'Greendale', 'Greenfield Park', 'Gregory Hills', 'Greystanes',
    'Guildford', 'Guildford West', 'Hammondville', 'Harris Park', 'Hassall Grove',
    'Hebersham', 'Heckenberg', 'Henley', 'Hinchinbrook', 'Hobartville',
    'Holroyd', 'Holsworthy', 'Homebush', 'Homebush West', 'Horningsea Park',
    'Huntingwood', 'Hoxton Park', 'Illawong', 'Ingleburn', 'Jordan Springs',
    'Kareela', 'Kearns', 'Kellyville Ridge', 'Kemps Creek', 'Kentlyn',
    'Kings Langley', 'Kings Park', 'Kingswood', 'Kirkham', 'Kogarah', 'Kogarah Bay',
    'Belfield', "Belmore", "Clarendon", "Colyton", "Constitution Hill", "Cowan", "Cliftonville", "Fox Studios",
    "Equality Green", "Crosslands", "Mobbs Hill", "Gore Hill", "Jack Mundey Place", "Golden Grove", "Gooseberry Flat",
    "Hewitt Hillside", "Central", "Argyle Cut", "Little Greece", "Little Italy", "Little Portugal", "Little Vietnam",
    "Corr Neighbourhood Centre", "Birrong", "Botany", "Carlingford", "Camellia", "Carramar", "Cheltenham", "Chester Hill",
    "Chipping Norton", "Canoelands", "Cattai", "Strawberry Hills",
    "Taylor Square", "Town Hall", "Wynyard", "Walsh Bay", "Victoria Cross", "Queens Square"
  ],

  "Inner West Sydney": [
    "Newtown", "Ashfield", "Marrickville", "Abbotsford", 
    "Ashbury", "Balmain", "Balmain East", 
    "Croydon", "Croydon Park", "Earlwood", "Lilyfield", "Mortlake", 
    "Drummoyne", "Dulwich Hill", "Summer Hill",
    "Petersham", "Leichhardt", "Annandale",
    "Stanmore", "Surry Hills", "Tempe", "Sydenham",
    "St Peters", "Waterloo", "Ultimo", "Darlington",
    "Burwood", "Burwood Heights","Camperdown", "Canterbury", "Campsie", "Chiswick",
    "Breakfast Point", "Cabarita", "Canada Bay",
    "Clyde", "Concord", "Concord West", "Clemton Park", "Dobroyd Point",
    "Five Ways", "Broadway", "Macdonaldtown", "Chinatown",
    "Enfield", "Enmore", "Eveleigh", "Eschol Park", "Glebe",
    "The Rocks", "Redfern", "Rozelle", "Russell Lea",
    'Haberfield', 'Hurlstone Park', 'Lewisham'
  ],

  "Eastern Suburbs": [
    "Bondi", "Randwick", "Coogee", "Alexandria", 
    "Beaconsfield", "Daceyville", "Darling Point", "Darlinghurst", 
    "Double Bay", "Dover Heights", "Eastgardens", "Eastlakes", 
    "Little Bay", "La Perouse", "Malabar", "Matraville", "Mascot", "Moore Park",
    "Paddington", "Potts Point", "Point Piper", "Kyeemagh",
    "Maroubra", "Phillip Bay",
    "North Bondi", "Queens Park", "Queenscliff",
    "Bellevue Hill","Bondi Beach", "Bondi Junction",
    "Bronte", "Centennial Park", "Chifley","Rose Bay North","Paradise Beach", "The Basin",
    "Clovelly", "Maroubra Junction", "Pagewood", "Kurnell",
    "Charing Cross", "Diamond Bay", "Ben Buckler",
    "Tamarama", "Centennial Parklands Dining Precinct",
    "Centennial Parklands Entertainment Quarter", "Centennial Parklands Office Precinct", "Centennial Square",
    "East Sydney", "Darling Square", "Kings Cross",
    "Rose Bay", "Rosebery", "Rushcutters Bay", "South Coogee", "Vaucluse", "Watsons Bay",
    "Waverley", "Woollahra", "Edgecliff", 
    "Elizabeth Bay", "Elvina Bay", "Fairlight", "Woolloomooloo",
    "Zetland", 'Hillsdale', 'Kensington', 'Kingsford'
  ],

  "North Shore": [
    "Cremorne", "Crows Nest", "Darlington", 
    "Denistone", "Denistone East", "Denistone West",
    "East Killara", "Lane Cove", 
    "Lane Cove North", "Lane Cove West", "Longueville",
    "Cremorne Point", "Kurraba Point", "McMahons Point",
    "Lavender Bay", "Middle Cove", "Berowra", "Berowra Heights", "Berowra Waters",
    "Berrilee", "Chatswood", "Chatswood West", "Cheltenham",
    "Mosman", "Mosman Junction", "Cremorne Junction", "Neutral Bay", "Kirribilli",
    "Waverton", "Milsons Point", "Clifton Gardens", "Balmoral", "Beauty Point",
    "Georges Heights", "Mosmans Bay", "Wollstonecraft", "St Leonards", "Cammeray",
    "Chatsworth", "East Lindfield", "Fox Valley", "Fullers Bridge", "Barra Brui",
    "East Wahroonga", "Normanhurst", "Pymble", "St Ives", "St Ives Chase", "Wahroonga",
    "Killara", "Gordon", "Lindfield", "Castle Cove", "Castlecrag",
    "North Sydney", "Naremburn", "North Willoughby", "Northwood", 
    "North Turramurra", "North Wahroonga", "Northbridge",
    "Roseville", "Roseville Chase", "Ryde", "Tamarama", "Turramurra", "Waitara", "Warrawee", 
    "Warriewood", "West Pymble", "Seaforth",
    "Thornleigh", "Terrey Hills",
    "Neutral Bay Junction", "North St Ives",
    "The Spit",
    "Spit Junction",
    "Sorlie",
     'Killarney Heights', 'Ku-ring-gai Chase', 'Beecroft'
  ],
  "Northern Sydney": [
    "West Ryde", "Westleigh", "Wheeler Heights", "Willoughby", "Willoughby East",
    "Woolwich", "Wollstonecraft", "Elanora Heights", "Epping", "Ermington",
    "Forestville", "Frenchs Forest", "Freshwater", "Galston", "Gladesville",
    "Pearces Corner",
    "Ryde Central"
  ],

  "Northern Beaches": [
    "Balgowlah", "Balgowlah Heights", "Bayview", "Beacon Hill", 
    "Cromer", "Curl Curl", "Dee Why", "Davidson", "Duffys Forest", 
    "Manly", "Manly Vale", "Mona Vale",
    "Lovett Bay", "Morning Bay", "Currawong Beach", "Bilgola Beach",
    "Bilgola Plateau", "Brookvale",
    "Newport",
    "Newport Beach",
    "Narrabeen Peninsula",
    "Wingala",
    "Avalon Beach", "Clareville", "Church Point", "Collaroy", "Collaroy Plateau", "Collaroy Beach",
    "Dee Why Beach", "Coasters Retreat", "Fishermans Beach", "Long Reef",
    "Palm Beach", "Careel Bay", "Cottage Point",
    "Queenscliff", "Fairlight", "Allambie", "Cromer Heights",
    "McCarrs Creek",
    "Narrabeen", "Narraweena", 
    "North Manly", "North Balgowlah", "North Curl Curl", "North Narrabeen", 
    "North Turramurra", "North Wahroonga", "South Turramurra", "Seaforth", "Warriewood",
    "Scotland Island", 'Middle Dural'
    
  ],

  "Hills District": [
    "Castle Hill", "Rouse Hill", 
    "The Ponds", "Beaumont Hills",
    "Middle Dural", "Maraylya", "Maroota",
    "Round Corner",
    "Thompsons Corner",
    "Quarry Hill",
    'Dural', 'Kellyville Ridge',
    "Box Hill", "Castle Cove", "Castlecrag", "Cherrybrook",
    "Crestwood", "Baulkham Hills", "Norwest", "Bella Vista",
    "Winston Hills", "North Kellyville",
    "Kellyville", "West Pennant Hills"
  ],

  "Western Sydney": [
    "Mount Druitt", "Doonside", "Fairfield", "Granville", 
    "Quakers Hill", "Schofields", "Arndell Park", "Airds", "Ambarvale", 
    "Austral", "Dean Park", "Eastern Creek", "Minchinbury", "Marsden Park", 
    "Melonba", "Lethbridge Park", "Dharruk",
    "Eagle Vale", "Edensor Park", "Lurnea", "Macquarie Fields", 
    "Macquarie Links", "Minto", "Minto Heights", "Old Toongabbie", "Plumpton", 
    "Pemulwuy", "Pendle Hill", "Regentville", "Ropes Crossing",
    "Rosehill", "Seven Hills", "St Clair", "St Marys", "Strathfield South", "Toongabbie",
    "Werrington", "Werrington County", "Werrington Downs", "West Pennant Hills",
    "Wentworthville", "South Wentworthville", "South Granville", "South Windsor", 
    "Vineyard", "Sydney Olympic Park", "Wentworth Point", "Epping", "Ermington", "Five Dock", "Girraween", "Forest Glen", "Forest Lodge",
    "Gables", "Galston", "Georges Hall", "Frenchs Forest", "Forestville",
    'Luddenham', 'Mulgoa', 'Prospect', "Berala",
    "Berkshire Park",
    "Bidwill",
    "Blackett",
    ...
    "Carramar",
    "Casula",
    "Colyton", "Cranebrook", "Claremont Meadows", "Dunheved",
    "Kingswood Park", "Lalor Park", "Rooty Hill", "Blacktown Industrial Area",
    "Cecil Park",
    "Caddens",
    "Cambridge Gardens",
    "Cambridge Park",
  ...
  "South Sydney & Sutherland Shire": [
    "South Hurstville", "Sylvania", "Sylvania Waters", "Taren Point",
    "Sutherland", "Waterfall", "Engadine", "Woronora", "Woronora Heights", "Yarrawarrah", "Woolooware", "Yowie Bay",
    "Padstow Heights"
  ],

  "Western & South-West Outer Sydney": [
    "Singletons Mill", "Ropes Crossing", "Rydalmere", "Pendle Hill", "Telopea", 
    "Wentworth Point", "Oxley Park", "South Penrith", "Bringelly",
    "Bradfield",
    "Catherine Field",
    "Cecil Park",
    "Caddens"
  ...
  "South West Sydney": [
    ...
    "Ashcroft", "Bardia", "Denham Court", "Currans Hill", 
    "Edensor Park", "Lurnea", "Miller", "Moorebank", "Middleton Grange", 
    "Macquarie Links", "Eagle Vale", 
    "Luddenham", "Long Point",
    "Mount Annan", "Campbelltown", "Raby", "Minto", 
    "Minto Heights", "Menangle Park", "Narellan", "Narellan Vale",
    "Rosemeadow", "Rossmore", "Ruse", "Sadleir", "Sefton", "Shalvey", "Shanes Park",
    "Smeaton Grange", "Smithfield", "Spring Farm", "St Andrews", "St Helens Park", 
    "St Johns Park", "Tregear", "Varroville", "Villawood", "Wakeley", "Warwick Farm", 
    "Wedderburn", "West Hoxton", "Elderslie", "Emerton", "Englorie Park", "Erskine Park", "Gilead", 
    "Gledswood Hills", "Glen Alpine", "Glendenning", "Glenfield", "Fairfield East",
    "Fairfield Heights", "Fairfield West", "Elizabeth Hills", "Woodcroft", "Woodbine",
    "Whalan", "Willmot", "Yennora", 'Hoxton Park', 'Horsley Park', 'Kemps Creek', 
    'Kentlyn', 'Ingleburn', 'Macquarie Fields', 'Oran Park',
    "Blair Athol",
    "Cobbitty", "Claymore", "Condell Park", "East Hills", "Revesby", "Padstow", "Padstow Heights",
    "Milperra", "Chullora", "Lansvale", "Fairfield", "Wetherill Park",
    "Leumeah", "Prestons", "Casula",
    "Blairmount",
    "Bradbury",
    "Mount Pleasant",
    "Murray Farm",
  ...
  "St George & Sutherland": [
    "Arncliffe", "Bangor", "Banksia", "Banksmeadow", "Bankstown", 
    "Bankstown Aerodrome", "Barden Ridge", "Bardwell Park", 
    "Bardwell Valley", "Bass Hill", "Cronulla", "Dolans Bay", 
    "Dolls Point", "Kurnell", "Kyle Bay", "Kyeemagh", 
    "Loftus", "Menai", "Miranda", "Maianbar",  "Monterey",
    "Beverley Park",
    "Bexley",
    "Bexley North",
    "Blakehurst",
    ...
    "Burraneer",
    "Carlton",
    "Connells Point", "Como", "Caravan Head", "Bald Face", "Peakhurst",
    "Peakhurst Heights", "Riverwood", "Mortdale", "Beverly Hills", 
    "Lilli Pilli", "Port Hacking", "Caringbah", "Caringbah South", "Taren Point",
    "Carss Park",
    "Padstow", "Padstow Heights", "Panania",
    "Oatley", "Lugarno", "Penshurst", "Oyster Bay", "Kogarah",
    'Gymea', 'Gymea Bay', 'Kangaroo Point', 'Kirrawee'
  ],

  "Wollongong & Illawarra": [
    "Wollongong", "Fairy Meadow", "Shellharbour", "Dapto", "Corrimal", 
    "Figtree", "Albion Park", "Austinmer", "Balgownie", "Bellambi", 
    "Berkeley", "Bulli", "Coledale", "Coniston", "Helensburgh", 
    "Kanahooka", "Keiraville", "Mount Ousley", "North Wollongong", 
    "Port Kembla", "Stanwell Park", "Thirroul", "Towradgi", 
    "Unanderra", "Woonona", "Albion Park Rail", "Barrack Heights", 
    "Blackbutt", "Calderwood", "Flinders", "Oak Flats", "Shell Cove", 
    "Warilla", "Windang", "Bombo", "Foxground", "Gerringong", 
    "Jamberoo", "Berry", "Bawley Point", "Culburra Beach", "Gerroa", 
    "Huskisson", "Kangaroo Valley", "Milton", "Mollymook", "Nowra", 
    "Shoalhaven Heads", "Ulladulla", 'Grays Point', 'Maianbar', 'Bundeena'
  ],

  "Blue Mountains": [
    "Katoomba", "Springwood", "Blaxland", "Glenbrook", "Lawson",
    "Mulgoa", "Laughtondale", "Lower Portland", "Leets Vale",
  ...
  "Central Coast": [
    "Dangar Island", "McCarrs Creek", "Morning Bay", 
    'Mona Vale', 'Newport', 'North Narrabeen',
    "Brooklyn", "Moore Park", "Coasters Retreat"  // technically Hawkesbury River region, but close to Central Coast classification
  ]
} 


type Region = "Greater Sydney" | "Central Coast" | "St George & Sutherland" 
  | "Hills District" | "South Sydney & Sutherland Shire" | "South West Sydney" 
  | "Western & South-West Outer Sydney" | "" | "Northern Beaches" | "Inner West Sydney" 
  | "North Shore" | "Northern Sydney" | "Eastern Suburbs" | "Western Sydney" 
  |  "Hills District" | "Wollongong & Illawarra" | "Blue Mountains";
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-3">
                    {cities.map(city => {
                      ...
                      return location ? (
                        <Link
                          key={location.slug}
                          href={`/all-services?location=${location.slug}`}
