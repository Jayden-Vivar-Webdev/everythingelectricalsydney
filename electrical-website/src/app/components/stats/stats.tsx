      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          {description?.split("\n\n").map((para, i) => (
            <p
              key={i}
              className="mt-8 text-xl leading-8 text-gray-300/90 font-light"
            >
              {para}
            </p>
          ))}
        ...
        <div
          className={`mt-24 grid gap-6 sm:gap-8 ${
          ...
          {featureItems?.map((item, index) => (
            ...
            >
              ...
              <div className="relative flex items-start mb-4 sm:mb-6 space-x-3 sm:space-x-4">
                ...
                {item.href ? (
                  <a href={item.href}>
                    <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-white leading-snug">
                      {item.name}
                    </h3>{" "}
                  </a>
                ) : (
