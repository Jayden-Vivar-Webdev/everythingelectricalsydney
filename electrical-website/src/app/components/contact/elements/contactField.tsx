            ...
            <div className="flex flex-wrap gap-5 text-sm text-gray-600">
              <div className="flex flex-col gap-1">
                ...
                <span className="flex gap-2">
                  ...
                  No job is too big or too small. Fill out the form with your
                  details and a brief description so we can provide an accurate
                  quote.
                </span>
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="flex gap-2">
                  <div className="w-3 h-3 rounded-full"></div>
                  Our friendly team will review your request and respond as
                  quickly as possible with the right solution for your home or
                  business.
                </span>
              </div>
            </div>
