...
export default function Custom404() {
  return (
    <>
    {/* <!-- Features Section --> */}
    <section className="relative min-h-screen bg-gray-900 flex items-center justify-center px-4 py-24" id="features">
  ...
  <div className="relative z-10 w-full max-w-4xl mx-auto text-center">
    ...
    <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-900/30 border border-blue-500/50 mb-8">
      ...
      <span className="text-blue-400 font-medium text-sm tracking-wider uppercase">System Maintenance</span>
    </div>
    ...
    <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-10 leading-relaxed">
      We&apos;re performing scheduled maintenance to improve your experience. Our services will be back online shortly.
    </p>
    
    {/* Contact prompt */}
    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 max-w-md mx-auto">
      <h3 className="text-white font-medium mb-3">Need immediate assistance?</h3>
      <p className="text-gray-300 text-sm mb-4">Contact our support team for urgent requests</p>
      <a 
        href="tel:0449003526" 
